  ...
  return (
    <div className="product-details-page">
      <main className="container">
        <section className="product-top">
          ...
          <div className="product-info">
            ...
            <div className="info-box">
              <div className="info-row"><div className="info-label">카드혜택</div><div className="info-value">무이자 혜택</div></div>
              ...
              <div className="selection-row" style={{ marginTop: '15px' }}>
                <div className="content">
                  <div className="mini-preview-box"
                    ...
                    style={{
                      display: 'flex', width: '260px', alignItems: 'center', padding: '10px',
        ...
        <section className="product-detail-tabs">
          <ul className="tab-menu">
            {['상품정보', '관련상품', '리뷰', 'Q&A', '배송/환불'].map(m => (
              <li key={m} onClick={() => setTab(m)} className={tab === m ? 'active' : ''}>{m}</li>
            ))}
          </ul>
        </section>
        ...
        {tab === '상품정보' && (
          <div className="product-content-area">
            ...
            <section className="product-bottom-toggle">
              <button className="toggle-btn" onClick={() => setIsDetailOpen(!isDetailOpen)}>
                {detailBtnText}
              </button>
              {isDetailOpen && (
        ...
        <div className="recommend-area" style={{ margin: '80px 0 40px', borderTop: '1px solid #eee', paddingTop: '40px' }}>
